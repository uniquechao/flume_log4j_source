 ...
 * <p>
 * <h1>改写备注</h1>
 * 1 增加了偏移量的public 方法 <br>
 * 2 增加了文件名的public 方法<br>
 * </p>
 * 
 * @see FileReader
 ...
 * 
 * @version %I%, %E%
 * @author Mark Reinhold 徐世超
 * @since JDK1.1
 */

public class XscBufferedReader extends Reader {
	 ...
	 */
	public XscBufferedReader(final Reader in, final int sz,
	 ...
	 * @param in A Reader
	 */
	public XscBufferedReader(final Reader in, final String fileName) {
		this(in, defaultCharBufferSize, fileName);
	}
	 ...
	 * stream if necessary.
	 */
	private int read1(final char[] cbuf, final int off, final int len)
			throws IOException {
		if (nextChar >= nChars) {
			/*
	...
	public boolean markSupported() {
		throw new IllegalArgumentException("not support this method  mark");
	}
	 ...
	 *        after reading characters up to this limit or beyond may fail. A
	 *        limit value larger than the size of the input buffer will cause a
	 *        new buffer to be allocated whose size is no smaller than limit.
